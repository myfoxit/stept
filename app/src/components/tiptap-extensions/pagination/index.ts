...
const PAGINATION_CONTAINER_SELECTOR = '[data-tiptap-pagination]'
...
${scope} .tiptap-pagination-gap {
  border-top: 1px solid #e5e5e5;
  border-bottom: 1px solid #e5e5e5;
}

${scope} .tiptap-page-footer::after {
  color: #6b7280;
}

${scope} .tiptap-page-footer,
${scope} .tiptap-page-header {
...
${scope} .tiptap-page-header-center,
${scope} .tiptap-page-footer-center {
  flex: 1;
  text-align: center;
}

${scope} { counter-reset: page-number; }
${scope} .tiptap-page-footer { counter-increment: page-number; }

${scope} .tiptap-page-break:last-child .tiptap-pagination-gap { display: none; }
${scope} .tiptap-page-break:last-child .tiptap-page-header { display: none; }
...
${scope} .tiptap-page-number::before { content: counter(page-number); }

${scope} .tiptap-first-page-header {
  display: flex;
  justify-content: space-between;
  align-items: center;
  width: 100%;
}
${scope} .tiptap-page-header-center { flex: 1; text-align: center; }
...
function pageDecorations({ options, isInitial = false, storage }: { options: PagesOptions; isInitial?: boolean; storage: PagesStorage }) {
  ...
  const pagesWidget = Decoration.widget(
    ...
    (view) => {
      ...
      const pageBreak = ({ firstPage = false, pageNumber = 0, totalPages = 0 }: { firstPage?: boolean; pageNumber?: number; totalPages?: number }) => {
        ...
        wrapper.classList.add('tiptap-page-break')
        ...
        footer.classList.add('tiptap-page-footer')
        ...
        gapDiv.classList.add('tiptap-pagination-gap')
        ...
        header.classList.add('tiptap-page-header')
  ...
  const firstHeaderWidget = Decoration.widget(
    ...
    (view) => {
      ...
      firstHeader.classList.add('tiptap-first-page-header')
