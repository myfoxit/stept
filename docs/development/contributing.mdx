---
title: "Contributing"
description: "How to contribute to stept."
---
...
```bash
git clone https://github.com/your-username/stept.git
cd stept
cp .env.example .env
make dev
```
...
- Use [GitHub Issues](https://github.com/myfoxit/stept/issues)
...
By contributing, you agree that your contributions will be licensed under the [MIT License](https://github.com/myfoxit/stept/blob/master/LICENSE).
