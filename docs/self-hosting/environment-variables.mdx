...
[SendCloak](https://github.com/myfoxit/dataveil) automatically detects and replaces personal data before it reaches any LLM API. Responses are transparently deobfuscated.
