---
title: "Reverse Proxy"
description: "Caddy and Nginx configuration for ondoki."
---

## Caddy (Default)

ondoki's production Docker Compose uses [Caddy](https://caddyserver.com/) as the reverse proxy. Caddy provides automatic HTTPS certificate provisioning via Let's Encrypt.
