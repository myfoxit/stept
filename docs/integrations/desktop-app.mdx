---
title: "Desktop App"
description: "Record screen workflows with the ondoki desktop application."
---

## Overview

The [ondoki Desktop](https://github.com/myfoxit/ondoki-desktop) app is a Windows application built with .NET 9 / WPF. It runs in the background and captures user actions — clicks, keystrokes, window switches — as individual steps with screenshots.

## Installation

1. Download the latest release from [GitHub Releases](https://github.com/myfoxit/ondoki-desktop/releases)
...
Source code and releases: [github.com/myfoxit/ondoki-desktop](https://github.com/myfoxit/ondoki-desktop)
