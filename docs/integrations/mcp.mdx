...
ondoki includes a [Model Context Protocol (MCP)](https://modelcontextprotocol.io/) server that lets external AI agents search and read your documentation. Connect Claude Desktop, Cursor, GitHub Copilot, or any MCP-compatible tool to your ondoki knowledge base.

## How It Works

The MCP server is mounted at `/mcp` on your ondoki backend and uses stateless HTTP transport via [FastMCP](https://github.com/jlowin/fastmcp). AI agents authenticate with project-scoped API keys and can list, search, and read your content.
...
<Tabs>
  ...
  <Tab title="Environment Variable">
    ...
    ```bash
    export ONDOKI_API_KEY=ondoki_your_api_key_here
    ```
