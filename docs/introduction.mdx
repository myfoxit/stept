...
**stept** is a self-hosted platform for capturing, organizing, and sharing process documentation. It helps teams turn screen recordings into step-by-step guides, write rich documents, and build a searchable knowledge base — all enhanced by AI.
...
Most process documentation tools are either too simple (screenshot-and-annotate) or too complex (enterprise knowledge management). stept sits in the middle:

- **Capture is fast** — record a workflow from the desktop app and stept auto-generates titles, summaries, tags, and per-step descriptions using AI.
...
| **Privacy Controls** | Optional PII obfuscation via [SendCloak](https://github.com/myfoxit/sendcloak) |

## How It Works

<Steps>
  <Step title="Capture a Workflow">
    Use the stept desktop app or Chrome extension to record a process. Each click, keystroke, and navigation is captured as a step with a screenshot.
  </Step>
  <Step title="AI Processes the Recording">
    stept automatically generates a title, summary, tags, difficulty rating, and per-step descriptions using your configured LLM.
  </Step>
...
<CardGroup cols={2}>
  <Card title="Quick Start" icon="rocket" href="/quickstart">
    Get stept running in 5 minutes with Docker Compose.
  </Card>
