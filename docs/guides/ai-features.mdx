...
[SendCloak](https://github.com/myfoxit/sendcloak) is a proxy that intercepts LLM requests, detects PII using Microsoft Presidio, replaces it with synthetic data, and de-masks the AI response.
