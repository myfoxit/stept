...
ondoki includes a full-featured block-based document editor built on [TipTap](https://tiptap.dev/). It supports slash commands, drag-and-drop blocks, images, tables, code blocks, and inline AI — similar to Notion or Outline.
