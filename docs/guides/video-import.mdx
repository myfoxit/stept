...
stept can convert video recordings into step-by-step workflows. Upload a video file, and an async processing pipeline extracts frames, transcribes audio, and generates annotated steps with AI.
