...
The Python backend is the core of stept. It provides:
...
- **SendCloak** — Intercepts AI requests, detects and replaces PII with synthetic data, deobfuscates responses
- Works standalone with built-in regex/pattern detection
- Optionally enhanced with **Microsoft Presidio** for NER-based name/org detection
