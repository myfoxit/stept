...
<p align="center">
  <a href="https://github.com/myfoxit/ondoki-web/actions/workflows/ci.yml"><img src="https://github.com/myfoxit/ondoki-web/actions/workflows/ci.yml/badge.svg" alt="CI" /></a>
  <a href="LICENSE"><img src="https://img.shields.io/badge/License-MIT-blue.svg" alt="MIT License" /></a>
  <a href="https://github.com/myfoxit/ondoki-web/stargazers"><img src="https://img.shields.io/github/stars/myfoxit/ondoki-web?style=social" alt="GitHub Stars" /></a>
</p>
...
**ondoki** is a self-hosted platform for capturing, organizing, and sharing process documentation. Teams use it to turn screen recordings into step-by-step guides, write rich documents, and build a searchable knowledge base — all enhanced by AI.
...
cd ondoki-web
cp .env.example .env
# Edit .env — at minimum set JWT_SECRET and ONDOKI_ENCRYPTION_KEY
docker compose up -d
```
...
```bash
# Set DOMAIN, JWT_SECRET, ONDOKI_ENCRYPTION_KEY, POSTGRES_PASSWORD in .env
...
| `ONDOKI_ENCRYPTION_KEY` | Fernet key for API key encryption | `make generate-key` |
...
| `CORS_ORIGINS` | `http://localhost:5173,ondoki://` | Comma-separated allowed origins |
...
|----------|-------------|
| `ONDOKI_LLM_PROVIDER` | `openai` / `anthropic` / `ollama` / `copilot` / `custom` |
| `ONDOKI_LLM_API_KEY` | API key for the chosen provider |
| `ONDOKI_LLM_MODEL` | Model name (e.g., `gpt-4o`, `claude-sonnet-4-20250514`) |
| `ONDOKI_LLM_BASE_URL` | Base URL (required for `ollama` and `custom`) |
...
Full documentation is available at [docs.ondoki.com](https://docs.ondoki.com) (powered by [Mintlify](https://mintlify.com)).
